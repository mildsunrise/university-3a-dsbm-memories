...
\subsection{Inicialització del display}
...
Més endavant, en la pràctica P4 es mesurarà i verificarà (pàgina~231) % TODO: link to P4
...
Això és el \commit{da6142aab1f1cf2a6bafaa3d98a55262c5f985bb}.
...
de l'LCD. Això s'explica a la pàgina~123. % TODO: link to p4
